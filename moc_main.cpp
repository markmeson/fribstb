...
void STBWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        STBWidget *_t = static_cast<STBWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject STBWidget::staticMetaObject = {
    { &QTableWidget::staticMetaObject, qt_meta_stringdata_STBWidget.data,
      qt_meta_data_STBWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *STBWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_STBWidget.stringdata0))
        return static_cast<void*>(const_cast< STBWidget*>(this));
